...
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs()
          ...
          .withKD(0)
          .withKS(0)
          .withKV(0.65); // might need change 0.22
  ...
  // This needs to be tuned to your individual robot
  public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(5.5); // 7.5
  ...
  private static final Angle kBackRightEncoderOffset = Rotations.of(-0.208251953125);
